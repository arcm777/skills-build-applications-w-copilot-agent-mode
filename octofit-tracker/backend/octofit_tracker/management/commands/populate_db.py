...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        logger.debug(f'Created users: {users}')
        ...
        logger.debug(f'Created activities: {activities}')
        ...
        logger.debug(f'Created leaderboard entries: {leaderboard_entries}')
        ...
        logger.debug(f'Created workouts: {workouts}')
